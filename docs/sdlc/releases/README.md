---
kind: wiki
title: "Releases — the authorization a tag needs before it leaves"
status: current
updated: 2026-09-15
---
# `docs/sdlc/releases/` — the authorization a tag needs before it leaves
...
`scripts/hooks/pre-push-gate.mjs` refuses a push whose HEAD carries a release tag with no `docs/sdlc/releases/<tag>.md`
...
`docs/sdlc/releases/TEMPLATE.md`. It names the tag, the commit, and the gate results — things that are checkable —
...
```sh
cp docs/sdlc/releases/TEMPLATE.md releases/api-v1.4.0.md
