...
> Companion to `../00-target-architecture.md` (§4 `domain/trace`, §9). Status: HISTORICAL — a review artifact from the re-architecture review, never updated after it landed.
