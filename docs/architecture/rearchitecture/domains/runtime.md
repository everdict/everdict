...
> `../00-target-architecture.md` (§4 `domain/runtime` + `domain/placement`, §9). Status: HISTORICAL — a review artifact from the re-architecture review, never updated after it landed.
