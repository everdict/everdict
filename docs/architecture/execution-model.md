...
envelope  = { id, capUsd?, capTokens?, capRuns? }              // the CAUSAL BUDGET this run draws from + delegates — §5; NOT the ownership TaskEnvelope (the AutonomyBoundary) — see ownership-protocol.md
