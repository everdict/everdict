import { type InitiativeRecord, type IssueRecord, NodeTypeSchema, type ProjectRecord } from "@everdict/contracts";
import { HarvestBuilder, type HarvestResult } from "./harvest.js";

// Structured harvesters for the INTENT stratum — the eval tracker (Initiative ⊃ Project ⊃ Issue).
// The ISSUE is the graph's hub: its links say what verifies it (`verified_by`), its resolution says
