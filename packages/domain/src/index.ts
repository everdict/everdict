...
// observation — the channel sealed into the trace + its one reader (evolution-lineage Track C)
export {
...
export { renderDelegationBrief, DELEGATE_REPORT_FILE } from "./delegation/render-brief.js";
