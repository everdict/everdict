import { type CapabilityOrigin, type RubricSpec, RubricSpecSchema } from "@everdict/contracts";
...
export class PgRubricRegistry implements RubricRegistry {
  ...
  register(tenant: string, spec: RubricSpec, createdBy?: string, origin?: CapabilityOrigin): Promise<void> {
