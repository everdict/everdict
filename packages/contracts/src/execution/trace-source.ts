...
import type { SpanAttrMapping } from "./span-mapping.js";
...
// The span-mapping vocabulary moved to its own module to break an import cycle (see there); re-exported under
// the names this module has always published, so every consumer is untouched.
export {
  EvidenceSelectorSchema,
  EvidenceSlotSchema,
  RESERVED_EVIDENCE_NAMES,
  SpanAttrMappingSchema,
} from "./span-mapping.js";
export type { EvidenceSelector, EvidenceSlot, SpanAttrMapping } from "./span-mapping.js";
