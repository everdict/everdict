...
CREATE TABLE IF NOT EXISTS assay_harness_templates (
...
CREATE INDEX IF NOT EXISTS assay_harness_templates_tenant_id_idx ON assay_harness_templates (tenant, id);

CREATE TABLE IF NOT EXISTS assay_harness_instances (
  tenant     text NOT NULL DEFAULT '_shared',
  id         text NOT NULL,
  version    text NOT NULL,
...
CREATE INDEX IF NOT EXISTS assay_harness_instances_tenant_id_idx ON assay_harness_instances (tenant, id);
