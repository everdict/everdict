...
CREATE TABLE IF NOT EXISTS assay_workspace_invites (
...
CREATE UNIQUE INDEX IF NOT EXISTS assay_workspace_invites_ws_id_idx ON assay_workspace_invites (workspace, id);
CREATE INDEX IF NOT EXISTS assay_workspace_invites_workspace_idx ON assay_workspace_invites (workspace);
