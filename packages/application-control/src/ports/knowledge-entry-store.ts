...
// Persistence port for knowledge entries — reified claims (the knowledge layer's record). Dual-scoped like Skills /
// browser profiles: `private` = a personal draft (creator-only),
