...
- Interfaces (`Driver` / `EvaluableHarness` / `Grader` / `Environment`) live HERE; implementations live in adapter packages. (This is the one deliberate inversion of the single-impl "no interfaces" rule — Assay is a plugin runtime.)
