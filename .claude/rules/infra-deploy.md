...
- Name-prefix every resource `everdict-${env}-<role>`; attach uniform tags `{Project, Environment, ManagedBy}`.
...
- IaC CI (tflint / fmt / validate, kubeconform) + ship Everdict's own Helm chart.
