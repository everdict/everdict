...
- Errors: throw a subclass of `AppError` from `@everdict/core`. Never throw raw `Error` across a package boundary; never propagate an SDK/HTTP error as-is — remap it.
