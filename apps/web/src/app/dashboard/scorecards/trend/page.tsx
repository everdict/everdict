                  ...
                  <table className="w-full text-sm">
                    <thead className="border-b border-border/70 text-left text-xs font-medium uppercase tracking-wide text-muted-foreground">
                      <tr>
                        ...
                        <th className="px-4 py-2.5 text-right font-medium">{trend.metric}</th>
                        <th className="px-4 py-2.5 text-right font-medium">Δ vs baseline</th>
                      ...
                      {trend.points.map((p) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-2.5">
                            <Link
                              href={`/dashboard/scorecards/${p.scorecardId}`}
                              className="font-sans transition-colors hover:text-foreground"
                            >
                              {p.harness}
                            </Link>
                          </td>
                          <td className="px-4 py-2.5 text-right">{fmtScore(p)}</td>
                          <td
