...
// Client wrapper for the Runtimes-page "Workspace runners" section. Supplies the manager's "install/manage GitHub App"
...
export function WorkspaceRunnersSection({
  workspace,
  runners,
  canWrite,
  githubApp,
