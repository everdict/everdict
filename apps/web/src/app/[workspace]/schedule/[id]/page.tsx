          ...
          {isPull && tmpl.pull ? (
            ...
            <>
              <Row label={t('rtDataset')}>
                <Link
                  href={`/${workspace}/dataset/${encodeURIComponent(tmpl.dataset?.id ?? '')}`}
              ...
              <Row label={t('rtHarness')}>
                <Link
                  href={`/${workspace}/harness/${encodeURIComponent(tmpl.harness?.id ?? '')}`}
                  className="rounded-sm hover:text-foreground hover:underline"
                >
                  <EntityRef
                    id={tmpl.harness?.id ?? ''}
              ...
              <Row label={t('rtRuntime')}>
                {runtimeLinkable ? (
                  <Link
                    href={`/${workspace}/runtime/${encodeURIComponent(tmpl.runtime ?? '')}`}
