...
import { assignHarnessTraceSinkAction } from '../api/manage-trace-source'

// Per-harness EXPORT selection — choose which registered trace source this harness's scorecard detail results
// (per-case trace+scores) are EXPORTED to. Same pool as the pull selection; the list is pre-filtered to sink-capable
// sources (otel is pull-only). '' = no export (clear the assignment → source: null).
