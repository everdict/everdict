...
export const DATASET_FACETS = ['team', 'creator', 'tag'] as const
export const DATASET_GROUPINGS = ['none', 'team', 'creator'] as const
...
export const datasetListSpec: ListViewSpec<DatasetSummary> = {
  facetValues: (dataset, facet) => {
    switch (facet) {
      case 'team':
        return dataset.teamId === undefined ? [] : [dataset.teamId]
      case 'creator':
