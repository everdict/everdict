  ...
  server.registerTool(
    "settle_campaign",
    {
      ...
      description:
        ...
        "identity_unverified. Adoption approval is over THIS answer — save the adopted version with " +
        "save_agent/register_harness afterwards, declaring the campaign's issue as its origin (from_issue), " +
        "so lineage and intent both land.",
      inputSchema: { id: z.string() },
    },
