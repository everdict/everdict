...
// Values never appear here (as everywhere: a spec references a secret by NAME, never by value). An omitted or blank
// entry keeps the current binding, so a partial body is a partial edit rather than a silent unbind.
