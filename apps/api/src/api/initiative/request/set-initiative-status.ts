...
export const SetInitiativeStatusBodySchema = z.object({
  ...
  // Completing is the release gate — refused while any issue under any of the initiative's projects is open.
  // Shipping with known gaps is allowed, but only as an explicit, recorded override.
