import { BadRequestError, NotFoundError, type Scorecard } from "@everdict/core";
...
// read-side derivations over the store + @everdict/suite — diff / trend / leaderboard / backfillModels. Composed
// only by the facade; getRecord is the facade's hydrating get (child-run references → embedded scorecard).
